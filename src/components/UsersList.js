                        ...
                        <TableBody>
                            {users.map((user) => (
                                <TableRow key={user.id}>
                                    ...
                                    <TableCell
                                        className="compact-cell">{user.responsibleManager ? `${user.responsibleManager.firstName} ${user.responsibleManager.lastName}` : '-'}</TableCell>
                                    <TableCell className="compact-cell">{user.company?.name || '-'}</TableCell>
                                    <TableCell className="compact-cell">{user.active ? <CheckIcon/> :
                                        <CloseIcon/>}</TableCell>
                                    <TableCell className="compact-cell">{user.approved ? <CheckIcon/> :
                                        <CloseIcon/>}</TableCell>
                                    <TableCell>
                                        <IconButton
                                        ...
                                        >
                                            ...
                                            {!user.active && (
                                                <MenuItem onClick={() => {
                                                    handleActivateClick(user.id, true);
                                                    handleMenuClose();
                                                }}>
